...
const OrderDetails: FC<TProps> = ({ number }) => {
  return (
    <>
      <p
        className={`${styles["order-number"]} text text_type_digits-large mb-8 text-center`}
      >
        {number}
      </p>
      ...
      <p
        className={`${styles["last-p"]} text text_type_main-default text_color_inactive mb-30 text-center`}
      >
