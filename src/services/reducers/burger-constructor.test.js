...
describe("burger-constructor reducer", () => {
  ...
  it("should handle DELETE_INGREDIENT", () => {
    expect(
      burgerConstructorReducer(
        ...
        { type: DELETE_INGREDIENT, index: 0 }
      )
  ...
  it("should handle SWAP_INGREDIENTS", () => {
    ...
    expect(
      burgerConstructorReducer(
        ...
        { type: SWAP_INGREDIENTS, index1: 0, index2: 1 }
      )
  ...
  it("should handle SET_SUM", () => {
    const sum = 1000;
    expect(
      burgerConstructorReducer(initialState, { type: SET_SUM, sum: sum })
    ).toEqual({ ...initialState, sum: sum });
  });

  it("should handle CLEAR_CONSTRUCTOR", () => {
    expect(
      burgerConstructorReducer(initialState, { type: CLEAR_CONSTRUCTOR })
