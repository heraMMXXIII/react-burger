...
describe("auth reducer", () => {
  ...
  it("should handle AUTH_REGISTER_START", () => {
    expect(authReducer(initialState, { type: AUTH_REGISTER_START })).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
  ...
  it("should handle AUTH_REGISTER_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_REGISTER_SUCCESS, user: user })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
  ...
  it("should handle AUTH_LOGIN_START", () => {
    expect(authReducer(initialState, { type: AUTH_LOGIN_START })).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
      requestSuccess: false,
  ...
  it("should handle AUTH_LOGIN_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_LOGIN_SUCCESS, user: user })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
  ...
  it("should handle AUTH_LOGOUT_START", () => {
    expect(authReducer(initialState, { type: AUTH_LOGOUT_START })).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
      requestSuccess: false,
  ...
  it("should handle AUTH_LOGOUT_SUCCESS", () => {
    expect(authReducer(initialState, { type: AUTH_LOGOUT_SUCCESS })).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
      requestSuccess: true,
  ...
  it("should handle AUTH_TOKEN_START", () => {
    expect(authReducer(initialState, { type: AUTH_TOKEN_START })).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
      requestSuccess: false,
  ...
  it("should handle AUTH_TOKEN_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_TOKEN_SUCCESS, user: user })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
  ...
  it("should handle AUTH_FORGOT_PASSWORD_START", () => {
    expect(
      authReducer(initialState, { type: AUTH_FORGOT_PASSWORD_START })
    ).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
  ...
  it("should handle AUTH_FORGOT_PASSWORD_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_FORGOT_PASSWORD_SUCCESS })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
  ...
  it("should handle AUTH_RESET_PASSWORD_START", () => {
    expect(
      authReducer(initialState, { type: AUTH_RESET_PASSWORD_START })
    ).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
  ...
  it("should handle AUTH_RESET_PASSWORD_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_RESET_PASSWORD_SUCCESS })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
  ...
  it("should handle AUTH_GET_USER_START", () => {
    expect(authReducer(initialState, { type: AUTH_GET_USER_START })).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
      requestSuccess: false,
  ...
  it("should handle AUTH_GET_USER_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_GET_USER_SUCCESS, user: user })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
  ...
  it("should handle AUTH_PATCH_USER_START", () => {
    expect(authReducer(initialState, { type: AUTH_PATCH_USER_START })).toEqual({
      ...initialState,
      requestStart: true,
      requestError: null,
      requestSuccess: false,
  ...
  it("should handle AUTH_PATCH_USER_SUCCESS", () => {
    expect(
      authReducer(initialState, { type: AUTH_PATCH_USER_SUCCESS, user: user })
    ).toEqual({
      ...initialState,
      requestStart: false,
      requestError: null,
