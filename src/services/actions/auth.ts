...
export const authRegisterAction =
  (form: TRegisterUser) => (dispatch: AppDispatch) => {
...
export const authLoginAction =
  (form: TLoginUser) => (dispatch: AppDispatch) => {
...
export const authForgotPasswordAction =
  (form: TForgotPassword) => (dispatch: AppDispatch) => {
...
export const authPatchUserAction =
  (form: TPatchUser) => (dispatch: AppDispatch) => {
